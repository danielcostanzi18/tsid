...
import ur5_force_conf as conf
from numpy import nan
from numpy.linalg import norm as norm
from tsid_manipulator import TsidManipulatorForce

print("".center(conf.LINE_WIDTH, "#"))
print(" TSID - Manipulator End-Effector Force Tracking ".center(conf.LINE_WIDTH, "#"))
print("".center(conf.LINE_WIDTH, "#"))
print("")
...
tsid = TsidManipulatorForce(conf)
